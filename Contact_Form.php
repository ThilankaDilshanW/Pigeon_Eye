...
$LName = $_POST['lasrname'];
$Email = $_POST['email'];
$Country = $_POST['country'];
$WContact = $_POST['Feedback'];
...
else
{
	...
	$query = "INSERT INTO Contact VALUES(DEFAULT,'$FName','$LName','$Email','$Country','$WContact','$Mesage')";
	...
	if (mysqli_query($con,$query))
	{
		...
		echo'<section class = "container"><div class="alert alert-success" role="alert">
  			<p class ="para"><strong>Sucusfully Sent !</strong>
