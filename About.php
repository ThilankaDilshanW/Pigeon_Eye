    ...
    <body>
        ...
        <section class = "container">
            <div class = "container hero_container mb-5">
                ...
                <img class = "img-fluid" src = "Images/About/img1.jpg">

                <div class = "hero_text">
                    <h1 class = "text-uppercase text-dark display-3"> Who we are </h1>
                </div>
        ...
        <!-- description section -->
        <section class = "container">
            <div class = "container description text-white">

                <div class = "mb-5">
                    <h2 class = "text-center text-white display-4"> NSBM Green University </h2>
                </div>
                
                <p> NSBM Green University, the nation's premier degree-awarding institute, is the first of its kind in South Asia. It is a government-owned self-financed institute that operates under the purview of the Ministry of Education. <br> 
                    As a leading educational center in the country, NSBM has evolved into becoming a highly responsible higher education institute that offers unique opportunities and holistic education on par with international standards while promoting sustainable living. </p>
                
                <p> NSBM offers a plethora of undergraduate and postgraduate degree programs under five faculties: Business, Computing, Engineering, Science and Postgraduate & Professional Advancement. <br> 
                    These study programs at NSBM are either its own programs recognized by the University Grants Commission and the Ministry of Higher Education or world-class international programs conducted in affiliation with top-ranked foreign universities such as University of Plymouth in UK and Victoria University in Australia. </p>
                 
                <p> Focused on producing competent professionals and innovative entrepreneurs for the increasingly globalizing world, NSBM nurtures its graduates to become productive citizens of society with their specialization ranging in study fields such as Business, Management, Computing, IT, Engineering, Science, Psychology, Nursing, Interior design, Quantity Surveying, Law, and Multimedia </p>
                 
                <p> Inspired by the vision of being Sri Lanka's best-performing graduate school and being recognize internationally, NSBM currently achieves approximately 3000 new enrollments per year and houses above 11,000 students reading over 50-degree programs under 4 faculties. <br> 
                    Moreover, over the years, NSBM Green University has gifted the nation with 14,000+ graduates and has proved its global presence with an alumni network spread across the world. </p>
                 
                <p> University is nestling on a 40-acre land amidst the greenery and serenity in Pitipana, Homagama, NSBM Green University, is an ultra-modern university complex constructed with state-of-the-art facilities and amenities that provides the perfect setting for high-quality teaching, learning and research </p>
                
                <div class = "row">
                    <div class = "col-lg-4 mt-3 mb-3 ">
                        <img class = "img-fluid w-100" src = "Images/About/img1.jpg">
                    </div>
                    <div class = "col-lg-4 mt-3 mb-3">
                        <img class = "img-fluid w-100" src = "Images/About/img2.png">
                    </div>
                    <div class = "col-lg-4 mt-3 mb-3">
                        <img class = "img-fluid w-100" src = "Images/About/img3.jpg">
                    </div>
                </div>
