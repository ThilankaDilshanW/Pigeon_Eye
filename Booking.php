    ...
    <body>
        ...
        <section class = "container">
            <div class = "container hero_container mb-5">
                ...
                <img class = "img-fluid" src = "Images/Booking/hero1.jpg">

                <div class = "hero_text">
                    <h1 class = "text-uppercase text-dark display-3"> Book Now </h1>
                </div>
        ...
        <section class = "container bookingform">

            <div class = "mb-5">
                <h2 class = "text-center text-white display-4"> Book Your Trip </h2>
                <h4 class = "text-center text-white"> Flight, Camera, Action! </h4>
            </div>
            ...
            <ul class = "nav nav-pills justify-content-center">
                ...
                <li class = "nav-item">
                    <a class = "nav-link active" data-bs-toggle = "pill" href = "#customer_details" id="cdli">
                        <h3 class = "text-center"> Customer Details </h3>
                    </a>
                </li>
                    
                <li class = "nav-item">
                    <a class = "nav-link" data-bs-toggle = "pill" href = "#booking_details" id="pdli">
                ...
                <div class = "tab-pane active" id = "customer_details"> 
                        ...
                        <div class = "mt-3">
                            <fieldset>
                                ...
                                <label for = "N"> <b class = "text-white-50"> Name : </b> </label>

                                <div class = "form-floating mb-3 mt-3">
                                    <input type = "text" name = "N" id = "N" class = "form-control" placeholder = "Enter your name" required>
                                ...
                                <label for = "A"> <b class = "text-white-50"> Address : </b> </label>
                                ...
                                <label for = "P"> <b class = "text-white-50"> NIC / Passport No : </b> </label>
                                
                                <div class = "form-floating mb-3 mt-3">
                                    <input type = "text" name = "P" id = "P" class = "form-control" placeholder = "Enter your NIC / passport number" required>
                                    <label for = "P"> Enter your NIC / Passport No </label>           
                                </div>

                                <label for = "PN"> <b class = "text-white-50"> Phone number : </b> </label>

                                <div class = "form-floating mb-3 mt-3">               
                                    <input type = "text" name = "PN" id = "PN" class = "form-control" placeholder = "Enter your phone no" required>
                                    <label for = "PN"> Enter your phone number </label>
                                </div> 
                            ...
                            <div class = "mt-4 col-12">
                                <input type = "reset" class = "btn btn-info" value = "Reset Form" data-bs-target =  "#customer_details">
                            </div>
                ...
                <div class = "tab-pane fade" id = "booking_details">
                        ...
                        <div class = "mt-3">
                            <fieldset>
                                ...
                                <label for = "Pack"> <b class = "text-white-50"> Package : </b> </label>

                                <div class = "form-floating mb-3 mt-3">
                                    <select name = "Pack" class = "form-select" id = "Pack" form = "Pack" required>
                                        <option selected disabled> -- select an option -- </option>
                                        <option value = "11"> GALLE / MATHARA - 2 Day Package </option>
                                        <option value = "12"> GALLE / MATHARA - 2 Day Package </option>
                                        <option value = "21"> ELLA / NUWARA-ELIYA - 3 Day Package 01 </option>
                                        <option value = "22"> ELLA / NUWARA-ELIYA - 3 Day Package 02 </option>
                                        <option value = "31"> KANDY / MATALE - 3 Day Package </option>
                                        <option value = "32"> KANDY / MATALE - 3 Day Package </option>
                                        <option value = "40"> TRINCOMALEE - 4 Day Package </option>
                                    </select>
                                </div>

                                 <label for = "Date"> <b class = "text-white-50"> Starting Date : </b> </label>
                                <div class = "form-floating mb-3 mt-3">
                                    <input type = "date" name = "Date" class = "form-control" id = "Date" required>
                                </div>

                                <label for = "Children"> <b class = "text-white-50"> No of Children : </b> </label>

                                <div class = "form-floating mb-3 mt-3 text-white">
                                    <select name = "Children" class = "form-select" id = "Children" form = "Children" required>
                                        <option selected disabled> -- select an option -- </option>
                                ...
                                <label for = "Adults"> <b class = "text-white-50"> No of Adults : </b> </label>

                                <div class = "form-floating mb-3 mt-3">
                                    <select name = "Adults" class = "form-select" id = "Adults" form = "Adults" required>
                                        <option selected disabled> -- select an option -- </option>
                                        <option value = "1"> 1 </option>
                                        <option value = "2"> 2 </option>
                                        <option value = "3"> 3 </option>
                                ...
                                <label for = "Veg"> <b class = "text-white-50"> No of Vegeterians : </b> </label>

                                <div class = "form-floating mb-3 mt-3">
                                    <select name = "Veg" class = "form-select" id = "Veg" form = "Veg" required>
                                        <option selected disabled> -- select an option -- </option>
                                        <option value = "1"> 1 </option>
                                        <option value =  "2">2 </option>
                                        <option value = "3"> 3 </option>
                                        <option value = "VegD"> 4 </option>
                                        <option value = "5"> 5 </option>
                                        <option value = "6"> 6 </option>
                                        <option value = "7"> 7 </option>
                                        <option value = "8"> 8 </option>
                                        <option value = "VegI"> 9 </option>
                                        <option value = "10"> 10 </option>
                                    </select>
                                </div>

                                <label for = "Other"> <b class = "text-white-50"> Other Details : </b> </label>

                                <div class = "form-floating mb-3 mt-3">
                                    <input type = "textarea" name = "Other" id = "Other" class = "form-control" placeholder = "Optional">
                            ...
                            <div class = "mt-4 col-6">
                                <input type = "reset" class = "btn btn-info" value = "Reset Form" data-bs-target =  "#booking_details">
                            </div>
                            
                            <div class = "mt-4 col-6">
                                <input type = "submit" class = "btn btn-info" value = "Submit All">
                            </div>
                            </div>
